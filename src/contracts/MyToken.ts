...
export class MyToken extends DeployableOP_20 {
    ...
    public override onDeployment(_calldata: Calldata): void {
        const maxSupply: u256 = u256.fromString('1000000000000000000000000000'); // Your max supply. (1000000)
        const decimals: u8 = 18; // itsnasimchwowdhury.
        const name: string = 'Test'; // ncb.
        const symbol: string = 'TEST'; // ncb.
